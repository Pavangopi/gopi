...
class Problem extends Op_timing {
	public void disease(){
	int ch;
	Scanner sc=new Scanner(System.in);
	System.out.println("	1.fever");
	System.out.println("	2.cough&cold flu ");
	System.out.println("	3.cardiology consultation");
	System.out.println("	4.neurology consulation ");
	System.out.println("	5.ciritcal health");
	System.out.println("Enter ur problem in number format");
	ch=sc.nextInt();
	Op_timing op=new Op_timing();
	switch(ch){
	case 1:
